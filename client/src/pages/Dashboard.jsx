...
const Dashboard = () => {
      ...
      datasets: [
        {
          ...
          borderColor: 'rgb(0, 179, 0)', // Green border for credited
  ...
  <div className="bg-zinc-800 p-4 w-[350px] rounded-lg shadow-lg border-green-500 border-2">
    ...
    <p className="text-green-200">100% Last Month</p>
      ...
      <div className="flex flex-col w-[1500px] mb-8">
        <div className="flex justify-between  mb-8">
          <div className="bg-zinc-800 p-6 rounded-lg w-[740px] shadow-lg h-96">
          ...
          <div className="bg-zinc-800 p-6 rounded-lg shadow-lg w-[740px] h-96">
